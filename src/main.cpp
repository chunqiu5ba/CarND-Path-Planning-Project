    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          //Car check for ahead, left and right
          ...
          for(int i=0; i<sensor_fusion.size(); i++) {
            ...
            if (check_car_lane == lane) {
              ...
              if(car_gap > 0  && car_gap < 30) {
                car_ahead = true;
              }
            } else if (check_car_lane - lane == -1) {
              if(car_gap > -15 && car_gap < 30) {
                car_left = true;
              }
            } else if (check_car_lane - lane == 1) {
              if(car_gap > -15 && car_gap < 30) {
          ...
          //--- Behavior Planning, change or keep lane
          ...
          //use the prevoius path's end point as starting reference 
            ...
            //use two points that make the math tangent to the previous path's end point
          ...
          for (int i = 0; i < ptsx.size(); i++) {
            //shift car rreference angle to 0 degrees
          ...
          for (int i=1; i<=50-previous_path_x.size(); i++) {
            //speed up when velocity is slow
            ref_vel += threshold;
